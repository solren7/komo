...
use crate::segment::entry::{NonAppendableSegmentEntry, SegmentEntry, StorageSegmentEntry};
...
fn drop_index_if_incompatible_keeps_non_appendable_index_on_on_disk_only_change() {
    ...
    use crate::segment::data_types::index::IntegerIndexParams;
    use crate::segment::fixtures::payload_context_fixture::{
        create_id_tracker_fixture, create_payload_storage_fixture,
    };
    use crate::segment::fixtures::payload_fixtures::INT_KEY;
    use crate::segment::index::PayloadIndex;
    use crate::segment::types::PayloadSchemaParams;
...
fn drop_index_if_incompatible_drops_appendable_index_on_on_disk_only_change() {
    use crate::segment::data_types::index::IntegerIndexParams;
    use crate::segment::fixtures::payload_context_fixture::create_struct_payload_index;
    use crate::segment::fixtures::payload_fixtures::INT_KEY;
    use crate::segment::index::PayloadIndex;
    use crate::segment::types::PayloadSchemaParams;
