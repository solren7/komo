...
use crate::common::universal_io::{CachedReadFs, Populate, UniversalRead, UniversalReadFs, UserData};
...
use crate::blobstore::config::LogstoreConfig;
use crate::blobstore::error::BlobstoreError;
use crate::blobstore::tracker::PointOffset;
use crate::blobstore::tracker::append_only::AppendOnlyTracker;
...
impl<V, S: UniversalRead> LogstoreReader<V, S> {
    ...
    pub(crate) fn clear_cache(&self) -> crate::blobstore::Result<()> {
        let Self {
            config: _,
            tracker,
            pages,
