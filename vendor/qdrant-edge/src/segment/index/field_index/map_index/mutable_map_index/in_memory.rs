...
pub(in crate::segment::index::field_index::map_index) struct InMemoryMapIndex<N: MapIndexKey + ?Sized>
where
    Vec<<N as MapIndexKey>::Owned>: Blob + Send + Sync,
{
    pub(in crate::segment::index::field_index::map_index) map:
        HashMap<<N as MapIndexKey>::Owned, RoaringBitmap>,
    pub(in crate::segment::index::field_index::map_index) point_to_values:
        Vec<Vec<<N as MapIndexKey>::Owned>>,
    /// Amount of point which have at least one indexed payload value
    pub(in crate::segment::index::field_index::map_index) indexed_points: usize,
    pub(in crate::segment::index::field_index::map_index) values_count: usize,
    ...
    pub(in crate::segment::index::field_index::map_index) sorted_keys:
...
where
    Vec<<N as MapIndexKey>::Owned>: Blob + Send + Sync,
{
    pub(in crate::segment::index::field_index::map_index) fn empty(prefix_index: bool) -> Self {
        Self {
            map: HashMap::new(),
    ...
    pub(in crate::segment::index::field_index::map_index) fn for_points_values(
        &self,
