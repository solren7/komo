...
use crate::common::universal_io::{MmapFile, Populate, UniversalWrite, UserData};
...
impl<S: UniversalWrite + Send + 'static> crate::quantization::EncodedStorage
...
impl<S: UniversalWrite + Send + 'static> crate::quantization::EncodedStorageBuilder
