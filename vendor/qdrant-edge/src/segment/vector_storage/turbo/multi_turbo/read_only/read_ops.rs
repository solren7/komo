...
use crate::common::universal_io::{UniversalRead, UserData};
use crate::quantization::EncodedStorage;
...
use crate::segment::data_types::vectors::{
    MultiDenseVectorInternal, TypedMultiDenseVector, VectorElementType,
};
...
use crate::segment::vector_storage::multi_dense::appendable_mmap_multi_dense_vector_storage::MultivectorMmapOffset;
use crate::segment::vector_storage::vector_storage_base::VectorStorageRead;
use crate::segment::vector_storage::{MultiTQVectorStorageRead, TurboMultiScoring, VectorOffsetType};
...
impl<S: UniversalRead> VectorStorageRead for ReadOnlyChunkedMultiTurboVectorStorage<S> {
...
impl<S: UniversalRead> MultiTQVectorStorageRead for ReadOnlyChunkedMultiTurboVectorStorage<S> {
...
impl<S: UniversalRead> TurboMultiScoring for ReadOnlyChunkedMultiTurboVectorStorage<S> {
