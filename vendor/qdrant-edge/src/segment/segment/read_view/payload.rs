...
use crate::segment::index::query_estimator::adjust_for_deferred_points;
...
use crate::segment::types::{Filter, Payload, PointIdType};
...
where
    ...
    TVD: VectorDataRead,
{
    pub fn read_payloads<P: AccessPattern, U: crate::common::universal_io::UserData>(
        &self,
