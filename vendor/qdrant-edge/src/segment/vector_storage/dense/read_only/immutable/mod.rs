use crate::common::universal_io::{Populate, UniversalRead};
...
use crate::segment::vector_storage::dense::immutable_dense_vectors::ImmutableDenseVectorData;
...
mod tests {
    ...
    use crate::segment::types::Memory;
