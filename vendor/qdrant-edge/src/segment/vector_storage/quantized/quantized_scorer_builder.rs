...
use crate::segment::vector_storage::{RawScorer, RawScorerImpl, raw_scorer_from_query_scorer};
...
pub(in crate::segment::vector_storage::quantized) trait QuantizedScorerDispatch {
...
pub(in crate::segment::vector_storage::quantized) fn internal_raw_scorer<'a, TEncodedVectors>(
    point_id: PointOffsetType,
...
pub(in crate::segment::vector_storage::quantized) fn internal_raw_multi_scorer<
    'a,
    QuantizedStorage,
    OffsetStorage,
>(
...
pub(in crate::segment::vector_storage::quantized) fn build_quantized_raw_scorer<'a, Q>(
    storage: &'a Q,
...
pub(in crate::segment::vector_storage::quantized) struct QuantizedScorerBuilder<'a> {
    quantization_config: &'a QuantizationConfig,
    query: QueryVector,
    distance: &'a Distance,
    datatype: VectorStorageDatatype,
...
impl<'a> QuantizedScorerBuilder<'a> {
    ...
    pub(in crate::segment::vector_storage::quantized) fn new_quantized_scorer<TElement, TMetric>(
        self,
    ...
    pub(in crate::segment::vector_storage::quantized) fn new_multi_quantized_scorer<
        TElement,
        TMetric,
        QuantizedStorage,
        OffsetStorage,
