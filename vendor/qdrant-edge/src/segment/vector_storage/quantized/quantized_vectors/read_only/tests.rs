...
use crate::segment::vector_storage::dense::dense_vector_storage::open_dense_vector_storage;
...
use crate::segment::vector_storage::vector_storage_base::{VectorStorage, VectorStorageRead};
...
fn scalar_cached_config() -> QuantizationConfig {
    ScalarQuantizationConfig {
        memory: Some(crate::segment::types::Memory::Cached),
        r#type: crate::segment::types::ScalarType::Int8,
        quantile: Some(0.99),
        always_ram: None,
    }
...
fn turbo_config(always_ram: bool) -> QuantizationConfig {
    QuantizationConfig::Turbo(crate::segment::types::TurboQuantization {
...
fn preopen_and_unlink(
    ...
    let vector_config = VectorDataConfig {
        ...
        storage_type: if on_disk {
            crate::segment::types::VectorStorageType::Mmap
        } else {
            crate::segment::types::VectorStorageType::InRamMmap
        },
        index: crate::segment::types::Indexes::Plain {},
        quantization_config: Some(quantization_config.clone()),
        multivector_config: multivector.then(crate::segment::types::MultiVectorConfig::default),
        datatype: None,
    };
