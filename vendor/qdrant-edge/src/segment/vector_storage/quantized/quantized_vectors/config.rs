...
use crate::segment::types::{Memory, QuantizationConfig};
...
pub(in crate::segment::vector_storage::quantized) enum QuantizedStorageKind {
    ScalarRam,
    ScalarMmap,
    PqRam,
    PqMmap,
...
impl QuantizedStorageKind {
    ...
    pub(in crate::segment::vector_storage::quantized) fn demote_ram_to_mmap(self) -> Self {
        match self {
...
impl QuantizedVectorsConfig {
    ...
    pub(in crate::segment::vector_storage::quantized) fn storage_kind(
        &self,
        on_disk_vector_storage: bool,
